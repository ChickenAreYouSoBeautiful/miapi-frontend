...
/** refreshSecreteKey POST /api/user/refresh/secreteKey */
export async function refreshSecreteKeyUsingPost(options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean_>('/api/user/refresh/secreteKey', {
    method: 'POST',
    ...(options || {}),
  });
}
...
export async function signInUsingPost(options?: { [key: string]: any }) {
  return request<API.BaseResponseString_>('/api/user/signIn', {
    method: 'POST',
    ...(options || {}),
  });
}
